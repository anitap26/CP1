...
class TestCalculate(unittest.TestCase):
    ...
    def test_add_method_returns_correct_result_with_large_numbers(self):
        self.assertEqual(1_000_000_001, self.calc.add(1_000_000_000, 1))
        self.assertEqual(-1_000_000_001, self.calc.add(-1_000_000_000, -1))
    ...
    def test_multiply_method_returns_correct_result(self):
        ...
        self.assertEqual(1_000_000_000, self.calc.multiply(1_000_000, 1_000))
